...
def download_model():
    ...
    # Load model using a relative path inside the Docker container
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    model_path = os.path.join(BASE_DIR, "lin_regress.sav")
...
async def index():
    return {
        "message": "Welcome to the Data Science Income API. Use the /predict endpoint to predict your income."
    }
